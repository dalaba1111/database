...
<body class="flex justify-center items-center h-screen">
    <div class="max-w-sm mx-auto">
        <h1 class="text-4xl font-bold text-center mb-4">Periodical Paper</h1>
        <form action="insert_sql_periodical.php" method="post" class="max-w-sm mx-auto">
            <div class="mb-4">
            ...
            <div class="mb-4">
                <label for="periodical" class="block">Periodical Name:</label>
                <input type="text" name="periodical_name" id="periodical_name" required
                    class="border border-gray-300 px-2 py-1 rounded">
            </div>
