...
<body class="flex justify-center items-center h-screen">
    <div class="max-w-sm mx-auto">
        <h1 class="text-4xl font-bold text-center mb-4">Self Info</h1>
        <form action="insert_sql_selfInfo.php" method="post" class="max-w-sm mx-auto">
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="email" id="email" required class="border border-gray-300 px-2 py-1 rounded">
            </div>
            <div class="mb-4">
            ...
            <div class="mb-4">
                <label for="office" class="block">Office:</label>
                <input type="text" name="office" id="office" required class="border border-gray-300 px-2 py-1 rounded">
            </div>
            <div class="mb-4">
