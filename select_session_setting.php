        ...
        <table class="min-w-full">
            <thead class="bg-gray-300">
                <tr>
                    ...
                    <th class="px-6 py-3 text-xs font-medium text-gray-500 uppercase tracking-wider">Co-author</th>
                    <th class="px-6 py-3 text-xs font-medium text-gray-500 uppercase tracking-wider">session_name</th>
                    <th class="px-6 py-3 text-xs font-medium text-gray-500 uppercase tracking-wider">session_position
                    </th>
                    <th class="px-6 py-3 text-xs font-medium text-gray-500 uppercase tracking-wider">Page</th>
            ...
            <tbody class="bg-gray-600">
                <?php while ($row = mysqli_fetch_array($result)): ?>
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-center text-gray-300">
                            <?php echo $row["co_author"]; ?>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-center text-gray-300">
                            <?php echo $row["session_name"]; ?>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-center text-gray-300">
                            <?php echo $row["session_position"]; ?>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-center text-gray-300">
                            <?php echo $row["page"]; ?>
                        </td>
...
<script>
    function deleteItem(id) {
        window.location.href = "delete_sql_session.php?id=" + id;
    };
    function addItem() {
        window.location.href = "insert_session.php"
    }
</script>
