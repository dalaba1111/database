            ...
            <tbody class="bg-gray-600">
                <?php while ($row = mysqli_fetch_array($result)): ?>
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-center text-gray-300">
                            <button onclick="deleteItem('<?php echo $row["name"]; ?>')" class="btn btn-square btn-outline">
...
<script>
    function deleteItem(name) {
        window.location.href = "delete_sql_specialty.php?name=" + name;
    };
    function addItem() {
        window.location.href = "insert_specialty.php";
    }
</script>
