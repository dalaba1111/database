        ...
        <table class="min-w-full">
            <thead class="bg-gray-300">
                <tr>
                    ...
                    <th class="px-6 py-3 text-xs font-medium text-gray-500 uppercase tracking-wider">identity</th>
...
<script>
    function deleteItem(id) {
        window.location.href = "delete_sql_plan.php?id=" + id;
    };
    function addItem() {
        window.location.href = "insert_plan.php"
    }
</script>
